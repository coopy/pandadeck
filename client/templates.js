(function (root, factory) {
    ...
    templatizer["main"] = function tmpl_main() {
        return '<div class="wrapper"><nav class="navbar navbar-default"><div class="container-fluid"></div><ul class="nav navbar-nav"><li><a href="/decks">My Decks</a></li></ul></nav><div class="main-content"><h1>PandaFlash.me</h1><div data-hook="page-container" class="page-container"></div></div></div>';
    };
